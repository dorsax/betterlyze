"""
Django settings for betterlyze project.
...
SECRET_KEY = 'django-insecure-@d^jmk8&m1ha8lt0r6migaz9*-e4pjl5bek0k(izr)2-qucd9z'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                "analyse.context_processors.events", 
            ],
        },
    },
]

WSGI_APPLICATION = 'betterlyze.wsgi.application'
